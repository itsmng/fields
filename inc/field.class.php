...
class PluginFieldsField extends CommonDBTM
{
    ...
    static private function showDomContainer($c_id, $itemtype, $items_id, $type = "dom", $subtype = "")
    {
        ...
        echo self::prepareHtmlFields($fields, $items_id, $itemtype, true, false, false, true);
    }
    ...
    static function prepareHtmlFields(
        $fields,
        $items_id,
        $itemtype,
        $canedit = true,
        ...
        if ($is_form_layout) {
            ...
            $container_label = PluginFieldsLabelTranslation::getLabelFor($container_for_label);
            $container_label = htmlspecialchars($container_label, ENT_QUOTES, 'UTF-8');
            if ($container_label === '') {
        ...
        foreach ($fields as $field) {
            ...
            $form_label = $safe_label;
            $label_with_required = $form_label;
            if ($field['mandatory'] == 1) {
                $label_with_required .= " <span class='text-danger'>*</span>";
            }
            ...
            if ($field['type'] === 'header') {
                ...
                if ($show_table) {
                    ...
                    $label = " <label for='{$field['name']}'>{$safe_label} $required</label>";

                    if (
                        stristr($container_obj->fields['itemtypes'], 'Ticket') !== false
                ...
                switch ($field['type']) {
                    case 'number':
                        ...
                        if ($canedit && !$readonly) {
                            renderTwigTemplate('/macros/wrappedInput.twig', [
                                'title' => $show_table ? $form_label : $label_with_required,
                                'input' => [
                                    'type' => 'number',
                                    'name' => $field['name'],
                                    'value' => $value
                            ...
                            if ($show_table) {
                                ...
                                renderTwigTemplate('/macros/wrappedInput.twig', [
                                    'title' => $form_label,
                                    'input' => [
                                        'content' => "<div class='form-control-plaintext'>" . $value . "</div>"
                                    ]
                                ]);
                            }
                        }
                    ...
                    case 'url':
                        ...
                        $after_link = '';
                        if ($value !== '') {
                            $after_link = "<a target=\"_blank\" href=\"$value\">" . __('show', 'fields') . "</a>";
                        }
                        if ($canedit && !$readonly) {
                            renderTwigTemplate('/macros/wrappedInput.twig', [
                                'title' => $show_table ? $form_label : $label_with_required,
                            ...
                            if ($show_table) {
                                ...
                                renderTwigTemplate('/macros/wrappedInput.twig', [
                                    'title' => $form_label,
                                    'input' => [
                                        'content' => "<div class='form-control-plaintext'>" . $link . "</div>"
                                    ]
                                ]);
                            }
                        }
                        ...
                        if ($canedit && !$readonly) {
                            ...
                            if ($show_table) {
                                ...
                                renderTwigTemplate('/macros/wrappedInput.twig', [
                                    'title' => $form_label,
                                    'input' => [
                                        'content' => "<div class='form-control-plaintext'>" . $formatted . "</div>"
                                    ]
                                ]);
                            }
                        }
                    ...
                    case 'dropdown':
                        if ($canedit && !$readonly) {
                            ...
                            $dropdown_value = Dropdown::getDropdownName($dropdown_table, $value);
                            if ($show_table) {
                                $html .= $dropdown_value;
                            } else {
                                renderTwigTemplate('/macros/wrappedInput.twig', [
                                    'title' => $form_label,
                                    'input' => [
                                        'content' => "<div class='form-control-plaintext'>" . $dropdown_value . "</div>"
                                    ]
                                ]);
                            }
                        }
                        ...
                        if ($canedit && !$readonly) {
                            ...
                            if ($show_table) {
                                ...
                                renderTwigTemplate('/macros/wrappedInput.twig', [
                                    'title' => $form_label,
                                    'input' => [
                                        'content' => "<div class='form-control-plaintext'>" . $yesno . "</div>"
                                    ]
                                ]);
                            }
                        }
                        ...
                        if ($canedit && !$readonly) {
                            ...
                            if ($show_table) {
                                ...
                                renderTwigTemplate('/macros/wrappedInput.twig', [
                                    'title' => $form_label,
                                    'input' => [
                                        'content' => "<div class='form-control-plaintext'>" . $date . "</div>"
                                    ]
                                ]);
                            }
                        }
                    ...
                    case 'datetime':
                        if ($canedit && !$readonly) {
                            ...
                            $datetime = Html::convDateTime($value);
                            if ($show_table) {
                                $html .= $datetime;
                            } else {
                                renderTwigTemplate('/macros/wrappedInput.twig', [
                                    'title' => $form_label,
                                    'input' => [
                                        'content' => "<div class='form-control-plaintext'>" . $datetime . "</div>"
                                    ]
                                ]);
                            }
                        }
                    ...
                    case 'dropdownuser':
                        ...
                        if ($canedit && !$readonly) {
                            ...
                            $username = getUserName($value, $showuserlink);
                            if ($show_table) {
                                $html .= $username;
                            } else {
                                renderTwigTemplate('/macros/wrappedInput.twig', [
                                    'title' => $form_label,
                                    'input' => [
                                        'content' => "<div class='form-control-plaintext'>" . $username . "</div>"
                                    ]
                                ]);
                            }
                        }
                        ...
                        if ($canedit && !$readonly) {
                            ...
                            if ($show_table) {
                                ...
                                renderTwigTemplate('/macros/wrappedInput.twig', [
                                    'title' => $form_label,
                                    'input' => [
                                        'content' => "<div class='form-control-plaintext'>" . $os_name . "</div>"
                                    ]
                                ]);
                            }
                        }
    ...
    static function showSingle($itemtype, $searchOption, $massiveaction = false)
    {
        ...
        //show field
        echo self::prepareHtmlFields($fields, 0, $itemtype, true, false, $massiveaction, false);
